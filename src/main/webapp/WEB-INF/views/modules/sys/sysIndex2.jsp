	...
	<div id="main">
		<div id="header" class="navbar navbar-fixed-top">
			<div class="navbar-inner">
				...
				<ul id="userControl" class="nav pull-right">
					...
					<li id="themeSwitch" class="dropdown"><a
						...
						<ul class="dropdown-menu">
							...
							<li><a
								href="javascript:cookie('tabmode','${cookie.tabmode.value eq '1' ? '0' : '1'}');location=location.href">${cookie.tabmode.value eq '1' ? '关闭' : '开启'}页签模式</a></li>
				...
				<div id="logo"
					style="background:url(${ctxStatic}/images/logo.png) right repeat-x;width:100%;">
					<div
						style="background:url(${ctxStatic}/images/logo.png) left no-repeat;width:100%;height:70px;"></div>
				</div>
				<script type="text/javascript">
		...
		<div class="container-fluid">
			...
			<div id="footer" class="row-fluid">
				...
				<!--  - Powered By <a href="https://github.com/thinkgem/jeesite" target="_blank">JeeSite</a> ${fns:getConfig('version')} -->
			</div>
		</div>
	</div>
	<script type="text/javascript"> 
